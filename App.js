...
import { fetchToken } from './store/authentification/auth';
...
export default function App() {
    ...
    // Fetch user authentication token at the start of the application.
    // If the token exists, set `isAuthenticated` state to true.
    useEffect(() => {
        fetchToken(setAuthenticated);
    }, []);
                ...
                <NavigationContainer>
                    <Stack.Navigator initialRouteName='DrawerNav'>
                        ...
                        <Stack.Screen name="Profile" options={{ title: 'Mon profil' }}>
                            {props => <RouteGuard {...props}><Profile /></RouteGuard>}
                        </Stack.Screen>
                        <Stack.Screen name="SignIn" options={{ title: 'Inscription' }}>
                            {props => <AuthRouteGuard {...props}><SignIn /></AuthRouteGuard>}
                        </Stack.Screen>
                        <Stack.Screen name="SignUp" options={{ title: 'Connexion' }}>
                            {props => <AuthRouteGuard {...props}><SignUp /></AuthRouteGuard>}
                        </Stack.Screen>
